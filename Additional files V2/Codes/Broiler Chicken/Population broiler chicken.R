...
Kint    : 1.886    :                  /h, intestinal transit rate constant.
...
Ka      : 0.568    :                  intestinal absorption rate constant (/h) 
...
Kint.mean    = 1.886    #                  /h, intestinal transit rate constant.
...
# Dosing, multiple oral gavage
Ka.mean      = 0.568     #                  intestinal absorption rate constant (/h) 
